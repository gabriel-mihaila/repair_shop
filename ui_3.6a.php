...
<body>
    <div> 
		<p>Sa se gaseasca pentru fiecare depanator numarul de devize (nume_depanator, cate_devize) cu data_finalizare in luna septembrie 2019:</p>
		<form method="post" action="3.6a.php">
		<table>
		<tr>
		<th> Luna </th>
