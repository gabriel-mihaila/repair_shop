...
<body>
    <div> 
		<p> Sa se gaseasca perechi de piese (id_p1, id_p2) care apar pe acelasi deviz in aceeasi cantitate. O pereche este unica in rezultat.</p>
		<form method="post" action="3.4b.php">
		<table>
		<tr>
