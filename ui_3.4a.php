...
<body>
    <div> 
		<p>Sa se gaseasca (id_d, descriere, fabricant, pret_c si pret_r) pentru piesele cu pretul de catalog mai mare decat pretul real:</p>
		<form method="post" action="3.4a.php">
		<table>
		<tr>
