...
<body>
	<h1>○ Functie procedurala pentru cantitate stoc ○</h1>
    <div> 
		<p>Introduceti cantitate stoc</p>
		<form method="post" action="3.3b.php">
		<table>
		<tr>
		<th> Cantitate </th>
		<td> <input type="number" name="cantitate" value=5> </td>
		</tr>
		<tr>
