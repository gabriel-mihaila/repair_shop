...
<body>
    <div> 
		<p>Sa se gaseasca pentru fiecare piesa folosita la devize cu data_finalizare in luna septembrie 2019 cantitatea totala (descriere, fabricant, cantitate_totala):</p>
		<form method="post" action="3.6b.php">
		<table>
		<tr>
		<th> Luna </th>
		<td> <input type="text" name="luna" value="Sep"> </td>
		</tr>
		<tr>
