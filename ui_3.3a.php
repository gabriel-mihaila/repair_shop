...
<body>
    <div> 
		<p>Sa se gaseasca detaliile pentru devizele care au constatare si sunt nefinalizate la data‚ 01-SEP-2019’, ordonat dupa data introducere:</p>
		<form method="post" action="3.3a.php">
		<table>
		<tr>
		<th> Luna </th>
